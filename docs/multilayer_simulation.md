...
- **Accounting**: total-internal-reflection, shadowed, non-converged, and out-of-window contributions go to per-layer `dropped_power` — never silently lost, never NaN.
